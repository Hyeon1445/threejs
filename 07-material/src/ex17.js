...
export default function example() {
  ...
  function draw() {
    ...
    material.map.needsUpdate = true; // 애니메이션 넣을 경우 필수

    textureContext.fillStyle = "green";
    textureContext.fillRect(0, 0, 400, 400);
    textureContext.fillStyle = "white";
    textureContext.fillRect(time * 50, 100, 50, 50);
    textureContext.font = "bold 50px san-serif";
    textureContext.fillText("text", 200, 200);
