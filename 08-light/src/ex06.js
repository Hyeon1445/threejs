...
export default function example() {
  ...
  gui.add(hemisphereLight.position, "x", -5, 5).name("light x");
  gui.add(hemisphereLight.position, "y", -5, 5).name("light y");
  gui.add(hemisphereLight.position, "z", -5, 5).name("light z");
